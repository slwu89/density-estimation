...
//
//
// // want an easy-to-use R interface.
//
// //' @param maxtree the largest tree size
// //' @param maxsave the largest tree to be saved
// //' @param mxlevel the maximum tree depth
// void TSDE(
// 	const Rcpp::NumericMatrix& dmatrix,
// 	c_u_int maxtree = 3e4,
// 	c_u_int maxsave = 1e3,
// 	c_u_int mxlevel = 35
// ){
//
// 	c_u_int nmlearn = dmatrix.nrow();
// 	c_u_int nmbvars = dmatrix.ncol();
//
//
// };
//
